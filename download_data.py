...
#   basePath = f"/content/data/{'/'.join(file.split('/')[0:2])}"
...
# df_with_3_rows.to_csv('data_to_download.csv')

# order_download.to_csv('order_download.csv')
...
# drivePath = '/content/gdrive/MyDrive/SERVIR_DATASET/'
# # drivePath = '/content/data/'
